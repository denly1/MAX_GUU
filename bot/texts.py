...
VERIFIED_NOTICE: str = _get("VERIFIED_NOTICE")
REJECTED_NOTICE: str = _get("REJECTED_NOTICE")
NEED_REGISTRATION: str = _get("NEED_REGISTRATION")
NEED_VERIFICATION: str = _get("NEED_VERIFICATION")
...
STATUS_LABELS: dict[str, str] = _get("STATUS_LABELS")
